...
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(statustip)
        self.solve.setStatusTip(QCoreApplication.translate("MainWindow", u"\u5bf9\u8868\u4e2d\u6240\u6709\u7ea6\u675f\u8fdb\u884c\u6c42\u89e3", None))
#endif // QT_CONFIG(statustip)
        self.solve.setText(QCoreApplication.translate("MainWindow", u"\u6c42\u89e3", None))
#if QT_CONFIG(statustip)
        self.add.setStatusTip(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u7ea6\u675f \u652f\u6301\u52a8\u6001\u66f4\u65b0", None))
#endif // QT_CONFIG(statustip)
